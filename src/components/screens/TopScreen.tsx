    ...
    return (
        <div>
            ...
            <main className="px-3">
                ...
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Distinctio itaque qui nihil iste esse ipsa impedit quia, molestiae officia recusandae hic inventore unde facilis eaque debitis est. Dolores, aperiam voluptatibus!</p>

                <div className="mt-5 flex gap-6">

                    <Link to='/images/forest' state={{ backgroundPath: location.pathname }} className="hover:opacity-90 transition">
                    ...
                    <Link to='/images/river' state={{ backgroundPath: location.pathname }} className="hover:opacity-90 transition">
                    ...
                    <Link to='/images/mountains' state={{ backgroundPath: location.pathname }} className="hover:opacity-90 transition">
