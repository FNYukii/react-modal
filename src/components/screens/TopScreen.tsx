        ...
        <div>
            ...
            <main className="px-3">
                ...
                <div className="mt-5 flex gap-6">
                    ...
                    <Link to='/images/forest' state={{ previousPath: location.pathname }}>
                    ...
                    <Link to='/images/river' state={{ previousPath: location.pathname }}>
                    ...
                    <Link to='/images/mountains' state={{ previousPath: location.pathname }}>
